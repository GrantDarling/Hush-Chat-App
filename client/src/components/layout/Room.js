                ...
                <div className='videos'>
                    <div className='host'>
                        ...
                        {!!room.host.allowVideo 
                            ? <video ref={videoElement} id="localVideo" playsInline autoPlay muted></video>  // <video id="localVideo" autoPlay playsInline controls={false}/> // <img src={HostPlaceholder}  alt="Host Placeholder" className='active-video' /> 
